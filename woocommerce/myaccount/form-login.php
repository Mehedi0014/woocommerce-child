...
<?php endif; ?>
			...
			<div class="loginRegistrationWrapper">
				<div class="container">
					<div class="row position-relative">

						<div class="forBorder"></div>
						<div class="forCercel">or</div>

						<div class="col-md-6">
							<div class="pr-md-5">
								<h2 class="h3"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h2>
								...
								<form class="woocommerce-form woocommerce-form-login login" method="post">
									...
									<p>
										<label class="w-100 mb-2 form-check-label woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
											<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'woocommerce' ); ?></span>
										</label>
										<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
										<button type="submit" class="wcCtBtnTwo woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
									</p>
						...
						<div class="col-md-6 mt-5 mt-md-0">
							<div class="pl-md-5">
								<h2 class="h3"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
								...
								<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
									...
									<p class="woocommerce-form-row form-row">
										...
										<button type="submit" class="wcCtBtnTwo woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
									</p>

									<?php do_action( 'woocommerce_register_form_end' ); ?>

									<div>
										<p class="h5">Sign up today and you will be able to :</p>
