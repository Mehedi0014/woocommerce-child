...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<legend><?php esc_html_e( 'Your Account Information', 'woocommerce' ); ?></legend>
	<div class="form-row">
		<div class="col-md-6">
		...
		<div class="col-md-6">
			<p class="woocommerce-form-row woocommerce-form-row--last form-row-last">
	...
	<div>
		...
		<button type="submit" class="btn wcCtBtnTwo woocommerce-Button button" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
