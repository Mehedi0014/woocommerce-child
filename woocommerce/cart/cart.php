...
<div class="container">
	<div class="row">
					...
					<tfoot>
						<tr>
							<td colspan="6" class="px-0">
								<div class="form-group discountCouponForm m-0 position-relative">
									...
									<!-- <button type="submit" class="wcCtBtnTwo">Apply Coupon</button> -->
									<button type="submit" class="wcCtBtnFour button position-absolute" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply Coupon', 'woocommerce' ); ?></button>
								</div>
							</td>					
						</tr>
						...
						<tr>
							<td colspan="6" class="border-0 p-0">
								<div id="updateAndReturnShop" class="row flex-md-row-reverse">
									<div class="col-md-6 text-center text-md-right">
										<button type="submit" class="wcCtBtnThree text-uppercase button" name="update_cart" value="<?php esc_attr_e( 'Update Shopping Cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update Shopping Cart', 'woocommerce' ); ?></button>
										<?php do_action( 'woocommerce_cart_actions' ); ?>
										<?php wp_nonce_field( 'woocommerce-cart', 'woocommerce-cart-nonce' ); ?>
									</div>
									
									<div class="col-md-6 text-center text-md-left mt-2 mt-md-0">
										<button class="wcCtBtnThree text-uppercase">
											<a href="<?php echo esc_url(home_url('/')); ?>/shop/">										
												<i class="fa fa-angle-double-left"></i> Continue Ordering
											</a>
										</button>
									</div>
								</div>
		...
		<div class="col-md-4">
			<?php echo woocommerce_cart_totals(); ?>
		</div>
	</div>
</div>
<div class="container">
...
<div class="cart-collaterals">
	<?php
		...
		// ai hook comment kore er functions gulo alada alasa show kora hoyeche.
	?>
</div>
